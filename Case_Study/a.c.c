...
int main()
{
    ...
    char ch = '\0';
    int Choice = 0, i = 0, flag = 0 ,temp = 0 ;
        ...
        switch(Choice)
        {
                ...
                case 7 :
                        ...
                        scanf("%d",&temp);
                         ...
                         ptr = realloc(ptr , temp * sizeof(struct student));
...
void Accept(struct student *sptr , int cnt)
{
    ...
    for(i = 0 ; i < cnt ; i++)
    {
            ...
            printf("\n %d You Enter Student Information \n ",i + 1);
